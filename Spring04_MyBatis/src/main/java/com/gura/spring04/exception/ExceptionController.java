...
/*
 * 예외가 발생했을 때 직접 에러페이지를 응답하려면 예외 컨트롤러를 정의해서 응답 할 수 있다
 * 예외 컨트롤러를 만들때는 @ControllerAdvice 어노테이션을 붙여서 만들면 된다
 */
@ControllerAdvice
public class ExceptionController {
	/*
	 * 스프링 프레임 워크가 동작하는 중에 DBFailException type의 예외가 발생하면 호출되는 메소드
